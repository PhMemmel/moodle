...
$string['csvzipfile'] = 'CSV or ZIP file';
...
$string['errornocsvfilefound'] = 'No csv file present in zip archive root, nothing can be imported.';
$string['errortoomanycsvfilesfound'] = 'Zip archive root must only contain one single csv file. Nothing has been imported.';
...
$string['exportfiles'] = 'Include files in export';
...
$string['keeporiginalfilenames'] = 'Keep original file names when exporting - Files with identical names will only be exported once!';
