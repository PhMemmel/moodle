...
export default class Modal {
     ...
     * @param {?string} js the JavaScript which eventually is contained in the modal template
     */
    constructor(root, js = null) {
        this.root = $(root);
        this.js = js;
    ...
    attachToDOM() {
        ...
        // attached to the DOM.
        if (this.js) {
            Templates.runTemplateJS(this.js);
            this.js = null;
        }
